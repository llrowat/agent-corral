...
export function TemplateCrudModal({ onClose }: Props) {
    ...
    <div className="modal-overlay" onClick={onClose}>
      ...
      >
        <div className="modal-header">
          <h3>Manage Launchers</h3>
          <button className="btn btn-sm" onClick={onClose}>
            Close
          </button>
        </div>

        <div className="split-layout" style={{ minHeight: 400 }}>
                ...
                <div className="form-group">
                  ...
                  >
                    <input
                      ...
                      style={{ width: "auto" }}
                    />
                    Use git worktree (isolate each session in its own working
                    copy)
                  </label>
                </div>
