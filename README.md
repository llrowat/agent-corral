...
- **Share config with your team through git** — Export a plugin to a git repo and your team can import it. Push updates to the repo and import sync keeps everyone's config up to date automatically.
